    ...
    <DashboardLayout>
      <HStack display="flex" justify="space-around">
        <Box mt="20px" gap="20px">
          <Text fontSize="30px" fontFamily="ubuntu">
            Contact Us
          </Text>
          <p color="grey" fontFamily="ubuntu">
        ...
        <Stack mt="20px">
          <Text color="green" fontFamily="ubuntu">
          ...
          <Checkbox fontFamily="ubuntu">
            I agree with Terms & Conditions.
          </Checkbox>

          <Button bg="	#E5E4E2" onClick={click} fontFamily="ubuntu">
            Send a Message
          </Button>
          <Button bg="	#E5E4E2" fontFamily="ubuntu">
            Book a Metting
          </Button>
        </Stack>
      </HStack>
